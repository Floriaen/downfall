...
local _Debug = {
	...
	AngelFaceFont = love.graphics.newFont(24),
	Proposals = {},
	ProposalLocation = _G;
	Proposal_String = "",
...
_Debug.overlay = function()
	...
	local R, G, B, A = unpack(_DebugSettings.OverlayColor)
	...
	if (#_Debug.order - _Debug.longestOffset > _Debug.lastRows - 1) then
		love.graphics.setFont(_Debug.AngelFaceFont)
